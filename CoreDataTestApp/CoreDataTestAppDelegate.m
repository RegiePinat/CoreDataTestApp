...
CoreDataTestViewController *tableController = [[CoreDataTestViewController alloc] initWithStyle:UITableViewStylePlain];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CoreDataTestApp.sqlite"];
